...
<div class="container mt-4">
    ...
    <strong class="h3">ویرایش آیتم گالری</strong>
    ...
    <table class="table">
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="direction: ltr!important" class="form-control w-100 mb-2" value="{{$gallery->image}}" readonly>
                                        </div>
                            ...
                            <tr>
                                ...
                                <textarea class="form-control" required name="describe" rows="3">{{$gallery->describe}}</textarea>
                                </div></td>
                            </tr>
                        </table>
