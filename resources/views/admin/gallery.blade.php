            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-right d-block">افزودن تصویر جدید <small class="text-muted d-block">حداکثر 4 مگابایت استاندارد 500 کلیوبایت</small></h5><br>
